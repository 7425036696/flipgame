...
import type { CardItem, GameState, GameMode, ViewState, Difficulty } from './types';
      ...
      <div className="w-full flex-grow flex flex-col items-center justify-center">
        ...
        {view === 'start' ? (
          ...
          <>
            ...
            {/* Game Board */}
            <div className={`relative w-full mx-auto aspect-square transition-all duration-300 ${
                gameState.difficulty === 'easy' 
                ? 'max-w-[min(90vw,60vh)] md:max-w-[min(60vw,60vh)]' 
                : 'max-w-[min(90vw,70vh)] md:max-w-[min(70vw,70vh)]'
            }`}>
              {/* Win Overlay */}
